...
void api(double dow, double up) {
    string command = URL_API + to_string((int)dow) + "/" + to_string((int)up);
...
void algo() {
    ...
    cin >> upcible2;
    cout << "=================================speedtest cible=======================================" << endl;
    thread worker(api,docible1, upcible2);
    system("cls");
...
void espace(string espace, int couleur) {
    HANDLE h = GetStdHandle(STD_OUTPUT_HANDLE);
...
int main() {
    ...
    */
    erreur();
    cout << "                          vérifier votre connéxions internet ou contacter l'administrateur" << endl;
